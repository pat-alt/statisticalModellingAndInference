...
3. *Non-juvenile undersampling*: draw $y_i$ from majority class $y_{n_{y=0}}$ with probability $1-\{\pi_i\}^{n_{y=0}}_{i=0}$ with $\{\pi_i\}^{n_{y=0}}_{i=0}$ defined by BLEV/OPT/PL. Remove $y_i$ from $y_{n_{y=0}}$ so that $n_{y=0} \leftarrow n_{y=0}-1$ until $n_{y=0}=n_{y=1}$.
